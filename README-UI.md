...
The project uses React+Redux using [this project](https://github.com/davezuko/react-redux-starter-kit) as the base. Refer to their docs for more.
...
#### API URL
The API URL can be set on `src/Api.js`
